...
public interface FlowMapper {
	...
	// Base
	//////////////////////////////////////
	@Select("SELECT * FROM flow " + " WHERE" + " flow_id = #{param1}")
	public FlowEntity selectByKey(String flowId);

	@Insert("insert into flow" + " (" + "flow_id," + "category_id," + "flow_name," + "flow_desc," + "publish_time,"
			+ "disable_flag," + "create_user," + "update_user," + "create_time," + "update_time" + " )" + " values"
			+ " (" + "#{flowId}," + "#{categoryId}," + "#{flowName}," + "#{flowDesc}," + "#{publishTime},"
			+ "#{disableFlag}," + "#{createUser}," + "#{updateUser}," + "now()," + "now()" + " ) ")
	public void save(FlowEntity entity);

	@Update("update flow " + " set" + " category_id=#{categoryId}" + " ,flow_name=#{flowName}"
	...
	@Update(" insert into publish_flow( " + " 		flow_id, " + " 		category_id, " + " 		flow_name, "
			+ " 		flow_desc, " + " 		disable_flag, " + " 		create_user," + " 		update_user,"
			+ " 		create_time, " + " 		update_time " + " 		) " + " 		select " + " 		flow_id, "
			+ " 		category_id, " + " 		flow_name, " + " 		flow_desc, " + " 		disable_flag, "
			+ " 		#{param2}, " + " 		#{param2}, " + " 		now(), " + " 		now() "
			+ " 		from flow where flow_id = #{param1} ")
	public void createPublishFlow(String flowId, String userId);

	@Update(" insert into publish_node( " + " 		flow_id, " + " 		node_id, " + " 		node_name, "
			+ " 		ref_name, " + " 		node_type, " + " 		start_type, " + " 		execute_type, "
			+ " 		start_cron, " + " 		sub_flow_id, " + " 		sub_node_id, " + " 		layout_x, "
			+ " 		layout_y, " + " 		skip_flag, " + " 		skip_value, " + " 		disable_flag, "
			+ " 		create_user, " + " 		update_user, " + " 		create_time, " + " 		update_time "
			+ " 		) " + " 		select " + " 		flow_id, " + " 		node_id, " + " 		node_name, "
			+ " 		ref_name, " + " 		node_type, " + " 		start_type, " + " 		execute_type, "
			+ " 		start_cron, " + " 		sub_flow_id, " + " 		sub_node_id, " + " 		layout_x, "
			+ " 		layout_y, " + " 		skip_flag, " + " 		skip_value, " + " 		disable_flag, "
			+ " 		#{param2}, " + " 		#{param2}, " + " 		create_time, " + " 		update_time "
			+ " 		from node where flow_id = #{param1} ")
	public void createPublishNode(String flowId, String userId);

	@Update(" insert into publish_node_http( " + " 		flow_id, " + " 		node_id, " + " 		timeout, "
			+ " 		timeout_type, " + " 		success_code, " + " 		error_type, " + " 		sync_flag, "
			+ " 		http_url, " + " 		http_method, " + " 		http_header, " + " 		http_body, "
			+ " 		http_content_type, " + " 		create_user, " + " 		update_user, " + " 		create_time, "
			+ " 		update_time " + " 		) " + " 		select " + " 		flow_id, " + " 		node_id, "
			+ " 		timeout, " + " 		timeout_type, " + " 		success_code, " + " 		error_type, "
			+ " 		sync_flag, " + " 		http_url, " + " 		http_method, " + " 		http_header, "
			+ " 		http_body, " + " 		http_content_type, " + " 		#{param2}, " + " 		#{param2}, "
			+ " 		create_time, " + " 		update_time " + " 		from node_http where flow_id = #{param1} ")
	public void createPublishNodeHttp(String flowId, String userId);

	@Update(" insert into publish_node_shell( " + " 		flow_id, " + " 		node_id, " + " 		timeout, "
			+ " 		timeout_type, " + " 		success_code, " + " 		error_type, " + " 		sync_flag, "
			+ " 		shell_location, " + " 		shell_param, " + " 		create_user, " + " 		update_user, "
			+ " 		create_time, " + " 		update_time " + " 		) " + " 		select " + " 		flow_id, "
			+ " 		node_id, " + " 		timeout, " + " 		timeout_type, " + " 		success_code, "
			+ " 		error_type, " + " 		sync_flag, " + " 		shell_location, " + " 		shell_param, "
			+ " 		#{param2}, " + " 		#{param2}, " + " 		create_time, " + " 		update_time "
			+ " 		from node_shell where flow_id = #{param1} ")
	public void createPublishNodeShell(String flowId, String userId);

	@Update(" insert into publish_node_roles( " + " 		flow_id, " + " 		node_id, " + " 		roles_id, "
			+ " 		create_user, " + " 		update_user, " + " 		create_time, " + " 		update_time "
			+ " 		) " + " 		select " + " 		flow_id, " + " 		node_id, " + " 		roles_id, "
			+ " 		#{param2}, " + " 		#{param2}, " + " 		create_time, " + " 		update_time "
			+ " 		from node_roles where flow_id = #{param1} ")
	public void createPublishRoles(String flowId, String userId);

	@Update("insert into publish_edge( " + "		flow_id, " + "		edge_id, " + "		from_node_id, "
			+ "		to_node_id, " + "		edge_condition, " + "		edge_exception_return_type, "
			+ " 		skip_flag, " + " 		skip_value, " + " 		disable_flag, " + " 		create_user, "
			+ " 		update_user, " + "		create_time, " + "		update_time " + "		) " + "		select "
			+ "		flow_id, " + "		edge_id, " + "		from_node_id, " + "		to_node_id, "
			+ "		edge_condition, " + "		edge_exception_return_type, " + " 		skip_flag, "
			+ " 		skip_value, " + " 		disable_flag, " + " 		#{param2}, " + " 		#{param2}, "
			+ "		create_time, " + "		update_time " + "		from edge where flow_id = #{param1} ")
